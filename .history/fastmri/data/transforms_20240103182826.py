...
class UnetData_2channel_allresolution_Transform_visual:
    ...
    def __call__(
        ...
        under_image = fastmri.ifft2c(masked_kspace_origin)
        ...
        return under_image.permute(2,0,1), target, 0, 0, fname, slice_num, max_value, mask.byte(), masked_kspace_origin, image_pocs.permute(2,0,1), masked_kspace_pocs
