...
class UnetData_2channel_allresolution_Transform_visual:
    ...
    def __call__(
        ...
        masked_kspace_img = copy.deepcopy(under_image)
        ...
        return under_image.permute(2,0,1), target, 0, 0, fname, slice_num, max_value, mask.byte(), masked_kspace_origin, image_pocs, masked_kspace_pocs
