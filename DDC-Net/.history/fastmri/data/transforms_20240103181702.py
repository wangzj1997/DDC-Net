...
class UnetData_2channel_allresolution_Transform_visual:
    ...
    def __call__(
        ...
        under_image = fastmri.ifft2c(masked_kspace_origin).permute(2,0,1)
        ...
        return under_image, target, 0, 0, fname, slice_num, max_value, mask.byte(), masked_kspace_origin, image_pocs, masked_kspace_pocs
