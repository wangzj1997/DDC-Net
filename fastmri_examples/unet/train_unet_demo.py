...
import sys
sys.path.append('/home/biit/MRI_GROUP/lxh/mri_lxh')
...
def build_args():
    ...
    data_path = pathlib.Path("/home/biit/fastmri_dataset/singlecoil_knee1")
    default_root_dir = pathlib.Path("/raid/MRI_group/exp") / "test_unet_baseline1"
